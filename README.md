...
- Windows hard gate run `31470329279` 已通过 Exchange 专项、Application Ports/Composition、Match Lineup chain、完整 architecture、保护资产、Application check/tests、完整 frontend 与完整 Rust 回归；AT1 当前为 `VERIFYING`，等待 clean publication 与正式 Public Platform CI。
