...
- AT2 Windows hard gate run `31298524184` 负责 Research/Database/Prediction 专项、Ports、architecture、Application check/tests、workspace Clippy/tests；通过前 R3-07 保持 `IN_PROGRESS`。
