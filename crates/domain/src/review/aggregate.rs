use super::{
    AbilityUpdateCandidateRecord, MatchEventSummary, MatchResultDraft, MatchResultRecord,
    MatchReviewEventDraft, MatchReviewEventRecord, PlayerMatchObservationDraft,
    PlayerMatchReviewRecord, SubstitutionDraft, SubstitutionRecord, TeamMatchReviewRecord,
};
...
pub struct MatchReviewDetail {
    ...
    pub event_summary: MatchEventSummary,
