...
use football_domain::{
    ...
    FormationUsageDistributionRecord, FormationUsageListQuery, LineupDraft, LineupPairDraft,
    LineupHistoryRemovalResult, LineupPairRecord, LineupRecord,
    MatchDraft, MatchLineupChain, MatchRecord, PlayerAbilityObservationDraft,
    PlayerAbilityObservationRecord, PlayerAvailabilityDraft, PlayerAvailabilityRecord,
    PlayerCatalogReferenceData, PlayerDetail, PlayerDraft, PlayerDynamicTagDraft,
    PlayerDynamicTagRecord, PlayerListPage, PlayerListQuery, PlayerMatchContribution,
    PlayerMatchContributionRequest, PlayerNameDraft, PlayerNameRecord, PlayerPositionDraft,
    PlayerPositionRecord, PlayerRecord, PlayerTeamPeriodDraft, PlayerTeamPeriodRecord,
    TeamCoachPeriodDraft, TeamCoachPeriodRecord, TeamDetail, TeamDraft, TeamListPage,
    TeamListQuery, TeamMatchLineupHistoryItem, TeamNameDraft, TeamNameRecord, TeamOption,
    TeamForceDeletePreview, TeamForceDeleteRequest, TeamForceDeleteResult, TeamProfileDraft,
    TeamProfileRecord, TeamRecord, TeamLineupPresetApplicationPreview,
    TeamLineupPresetDraft, TeamLineupPresetRecord,
};
use uuid::Uuid;
