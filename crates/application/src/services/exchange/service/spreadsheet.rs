...
impl ExchangeService {
    pub(crate) async fn export_team_package_template<P, F>(
        &self,
        session: F,
        output_path: String,
    ...
    pub(crate) async fn export_team_package_preview_json(
        &self,
        output_path: String,
    ...
    pub(crate) async fn preview_team_package_import<P, F>(
        &self,
        session: F,
        input_path: String,
    ...
    pub(crate) async fn commit_team_package_import<P, F>(
        &self,
        session: F,
    ...
    pub(crate) async fn export_player_catalog_template<P, F>(
        &self,
        session: F,
        output_path: String,
    ...
    pub(crate) async fn export_player_catalog_data<P, F>(
        &self,
        session: F,
        output_path: String,
    ) -> ApplicationResult<SpreadsheetExportSummary>
    ...
    pub(crate) async fn preview_player_catalog_import<P, F>(
        &self,
        session: F,
        input_path: String,
        mode: SpreadsheetImportMode,
    ...
    pub(crate) async fn resolve_player_catalog_import_conflict<P, F>(
        &self,
        session: F,
        batch_id: Uuid,
    ...
    where
        ...
        F: Future<Output = ApplicationResult<P>>,
    {
        exchange::resolve_player_catalog_import_conflict::execute(session, batch_id, resolution)
            .await
    }
    pub(crate) async fn commit_player_catalog_import<P, F>(
        &self,
        session: F,
        batch_id: Uuid,
    ...
    pub(crate) async fn read_player_catalog_import_preview<P, F>(
        &self,
        session: F,
        batch_id: Uuid,
    ) -> ApplicationResult<SpreadsheetImportPreview>
    ...
    pub(crate) async fn export_team_monthly_template<P, F>(
        &self,
        session: F,
        output_path: String,
    ...
    pub(crate) async fn export_team_monthly_data<P, F>(
        &self,
        session: F,
        output_path: String,
    ) -> ApplicationResult<MonthlyWorkbookExportSummary>
    ...
    pub(crate) async fn preview_team_monthly_import<P, F>(
        &self,
        session: F,
        input_path: String,
        mode: SpreadsheetImportMode,
    ...
    pub(crate) async fn read_team_monthly_import_preview<P, F>(
        &self,
        session: F,
        batch_id: Uuid,
    ) -> ApplicationResult<SpreadsheetImportPreview>
    ...
    pub(crate) async fn resolve_team_monthly_import_conflict<P, F>(
        &self,
        session: F,
        batch_id: Uuid,
        resolution: SpreadsheetImportResolution,
    ...
    pub(crate) async fn commit_team_monthly_import<P, F>(
        &self,
        session: F,
        batch_id: Uuid,
    ) -> ApplicationResult<SpreadsheetImportCommitResult>
