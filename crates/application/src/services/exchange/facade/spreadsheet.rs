...
impl ApplicationService {
    pub async fn export_team_package_template(
        ...
        self.exchange
            .export_team_package_template(self.exchange_session(), output_path)
            .await
    }
    ...
    pub async fn preview_team_package_import(
        ...
        self.exchange
            .preview_team_package_import(self.exchange_session(), input_path, mode)
            .await
    }
    pub async fn commit_team_package_import(
        ...
        self.exchange
            .commit_team_package_import(self.exchange_session(), request)
            .await
    }
    pub async fn export_player_catalog_template(
        ...
        self.exchange
            .export_player_catalog_template(self.exchange_session(), output_path)
            .await
    }
    pub async fn export_player_catalog_data(
        ...
        self.exchange
            .export_player_catalog_data(self.exchange_session(), output_path)
            .await
    }
    pub async fn preview_player_catalog_import(
        ...
        self.exchange
            .preview_player_catalog_import(self.exchange_session(), input_path, mode)
            .await
    }
    pub async fn resolve_player_catalog_import_conflict(
        ...
        self.exchange
            .resolve_player_catalog_import_conflict(self.exchange_session(), batch_id, resolution)
            .await
    }
    pub async fn commit_player_catalog_import(
        ...
        self.exchange
            .commit_player_catalog_import(self.exchange_session(), batch_id)
            .await
    }
    pub async fn read_player_catalog_import_preview(
        ...
        self.exchange
            .read_player_catalog_import_preview(self.exchange_session(), batch_id)
            .await
    }
    pub async fn export_team_monthly_template(
        ...
        self.exchange
            .export_team_monthly_template(self.exchange_session(), output_path)
            .await
    }
    pub async fn export_team_monthly_data(
        ...
        self.exchange
            .export_team_monthly_data(self.exchange_session(), output_path)
            .await
    }
    pub async fn preview_team_monthly_import(
        ...
        self.exchange
            .preview_team_monthly_import(self.exchange_session(), input_path, mode)
            .await
    }
    pub async fn read_team_monthly_import_preview(
        ...
        self.exchange
            .read_team_monthly_import_preview(self.exchange_session(), batch_id)
            .await
    }
    pub async fn resolve_team_monthly_import_conflict(
        ...
        self.exchange
            .resolve_team_monthly_import_conflict(self.exchange_session(), batch_id, resolution)
            .await
    }
    pub async fn commit_team_monthly_import(
        ...
        self.exchange
            .commit_team_monthly_import(self.exchange_session(), batch_id)
            .await
    }
}
