...
const HISTORICAL_MIGRATION_CONTRACT_SHA256 = "04b791e84d6cbc93aafebe4e0701fe09d435df1aad9e01955efc7567ca58592c";
...
assert(migration.includes(HISTORICAL_MIGRATION_CONTRACT_SHA256), "赛后结算历史迁移契约哈希不匹配");
...
assert(migration.includes("'automatic_parameter_promotion', false") && migration.includes("'p4_4_state', 'SHADOW_ONLY'"), "数据库历史契约未锁定人工晋升或 P4.4 影子边界");
...
console.log("赛后结算验证通过：当前公开提供器边界与冻结历史迁移分别验证，不可变结算、人工证据判定和漂移记录链路完整。");
