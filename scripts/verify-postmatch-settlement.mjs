...
const PUBLIC_MIGRATION_CONTRACT_SHA256 = "9d9f4f1f5a284b6882f5c3415943033d606a5299060346bf0ddd0c7afe13051d";
...
const application = read("crates/application/src/services/postmatch/facade.rs");
...
assert(migration.includes(PUBLIC_MIGRATION_CONTRACT_SHA256), "赛后结算公开迁移契约哈希不匹配");
...
assert(migration.includes("'automatic_parameter_promotion', false") && migration.includes("'provider_state', 'NOT_BUNDLED'"), "数据库公开契约未锁定人工晋升或外部提供器边界");
