...
assert(migration.includes(hash), "参数生命周期迁移中的契约哈希不匹配");
...
assert(migration.includes("'provider_state', 'NOT_BUNDLED'") && migration.includes("'automatic_promotion', false"), "数据库契约未锁定公开提供器边界或人工晋升");
