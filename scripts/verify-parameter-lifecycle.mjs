...
const PUBLIC_MIGRATION_CONTRACT_SHA256 = "439c22ace0712e035721a1b754cac616faf77a31df7575720bc09fe2e1867e1b";
...
assert(migration.includes(PUBLIC_MIGRATION_CONTRACT_SHA256), "参数生命周期公开迁移契约哈希不匹配");
...
assert(migration.includes("'automatic_promotion', false") && migration.includes("'provider_state', 'NOT_BUNDLED'"), "数据库公开契约未锁定人工晋升或外部提供器边界");
...
console.log("参数生命周期验证通过：公开提供器边界、人工晋升、不可变账本和回滚链路完整。");
